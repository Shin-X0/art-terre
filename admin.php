    ...
    <section class="section" id="admin">
      <div class="container">
        ...
        <div class="admin-links reveal">
          <a class="admin-link-card" href="admin-messages.php">
            <strong>✉️ Messages</strong>
            <small>Read and manage contact-form messages<?php echo $stats["unread"] > 0 ? " ({$stats["unread"]} unread)" : ""; ?></small>
          </a>
          <a class="admin-link-card" href="admin-orders.php">
            <strong>📦 Orders</strong>
            <small>View orders and update their status</small>
          </a>
          <a class="admin-link-card" href="admin-users.php">
            <strong>👥 Users</strong>
            <small>Change roles (collector / artist / admin), remove users</small>
          </a>
          <a class="admin-link-card" href="admin-artworks.php">
            <strong>🖼️ Artworks</strong>
            <small>Edit or remove any artist's listings</small>
          </a>
        </div>
