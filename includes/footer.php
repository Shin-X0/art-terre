        ...
        <form class="contact-form" id="contact-form" method="post" action="<?php echo $basePath; ?>pages/contact.php" novalidate>
          ...
          <?php if (isset($_GET["contact"])): ?>
            <?php if ($_GET["contact"] === "sent"): ?>
              <p class="upload-flash contact-flash" role="status">Message sent — the admin will reply soon!<?php if ($currentUser): ?> Read it in <a href="<?php echo $basePath; ?>pages/messages.php">My messages</a>.<?php endif; ?></p>
            <?php else: ?>
