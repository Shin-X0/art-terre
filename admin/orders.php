...
if ($_SERVER["REQUEST_METHOD"] === "POST" && csrf_check() && ($_POST["action"] ?? "") === "update_status") {
  ...
  header("Location: orders.php?updated=" . (int) $orderId);
  exit;
}
          ...
          <div class="orders-list">
            <?php foreach ($orders as $o): ?>
              <article class="order-card reveal">
                ...
                <form class="order-status-form" method="post" action="orders.php">
                  <?php echo csrf_field(); ?>
                  ...
                  <a href="../pages/order-pending.php?no=<?php echo urlencode($o["order_no"]); ?>" class="order-view-link">View →</a>
                </form>
              </article>
            <?php endforeach; ?>
          </div>
